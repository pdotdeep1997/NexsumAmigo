...
def get_agent_response(
    ...
    msg_history = [{"role": "system", "content": f"You are a friendly assistant that teaches Hindi like a supportive friend.{reminder_msg} Current Topic: {lesson_context}"}] + message_history + [{"role": "user", "content": message}]
    print(msg_history)
    response = client.chat.completions.create(
        model="ft:gpt-4.1-mini-2025-04-14:pdotdeep:lesson-plan-v1:BPNCchFh",
